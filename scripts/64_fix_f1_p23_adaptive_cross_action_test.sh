...
echo "== Fix F1-P23: test_cross_action_audit adaptativo segun modelos reales =="
echo "== Rama actual =="
...
echo "OK: test_cross_action_audit queda adaptado a modelos reales. Ejecuta validacion completa antes del commit."
